  ...
  return (
    <div className="flex-1">
      ...
      <div className='flex flex-1 justify-center '>
        <div className='flex flex-col mt-4 items-center bg-truegray-50 bg-opacity-25 dark:bg-gray-400 dark:bg-opacity-25 rounded-3xl z-10'>
        <Header className='bg-transparent'/> 
        <div className='p-5 mt-5 text-center dark:text-white'> Recent Graduate ( Developer / Learner / Artist )</div>
        <img className='flex items-center justify-center m-5 rounded-full border-2 border-red-400 min-w-100 w-1/6 h-auto' src={'/profile_pic.png'} />
